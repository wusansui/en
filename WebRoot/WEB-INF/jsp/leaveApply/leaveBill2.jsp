...
<html>
  ...
  <form action="leaveApply_completeTask?processInstanceId=${processInstanceId}&assignee=${assignee}" method="post">
    	<table class="table table-bordered table-hover">
    		...
    		<tr>
    			<td>请假原因</td>
    			<td><s:textarea name="#leaveBill.content"  disabled="true" cols="50"></s:textarea></td>
    		</tr>
    		<tr>
    			<td>部门经理审批</td>
    			<td><s:textarea name="#manageNote.message"  disabled="true" cols="50"></s:textarea></td>
    		</tr>
    		<tr>
    			<td>总经理审批</td>
    			<td><s:textarea name="topManageNote" cols="50"></s:textarea></td>
    		</tr>
    		<tr>
